...
\begin{itemize}
  ...
  \item \codeinline{04\_c4\_nivel3\_componentes.puml}: C4 nivel 3 --- componentes de la API (flujo de Feedback).
  ...
  \item \codeinline{13\_secuencia\_gestion\_citas.puml}: diagrama de secuencia --- flujo de gestión de citas (Admin).
  \item \codeinline{14\_secuencia\_mensajeria.puml}: diagrama de secuencia --- mensajería en tiempo real (Socket.IO).
  \item \codeinline{15\_secuencia\_autoagenda.puml}: diagrama de secuencia --- auto-agendamiento de cita por el paciente.
...
\section{Secuencia: Gestión de Citas (Admin)}
\lstinputlisting[language=plantuml,caption={\codeinline{13\_secuencia\_gestion\_citas.puml}}]{puml/13_secuencia_gestion_citas.puml}

\section{Secuencia: Mensajería en tiempo real}
\lstinputlisting[language=plantuml,caption={\codeinline{14\_secuencia\_mensajeria.puml}}]{puml/14_secuencia_mensajeria.puml}

\section{Secuencia: Auto-agendamiento de cita}
\lstinputlisting[language=plantuml,caption={\codeinline{15\_secuencia\_autoagenda.puml}}]{puml/15_secuencia_autoagenda.puml}
